  ...
  indicadores: [
    {
      ...
      archivo: 'ya10-1',
      hay_datos: true,
      explicacion_umbral: 'De acuerdo con el Plan Nacional de Desarrollo 2022 - 2026 no hay una meta para este indicador. Sin embargo el humbral debe ser cero.',
      explicacion: 'Indica el número de menores de edad o mujeres que fueron víctimas de delitos en contra de su libertad e integridad sexual.',
      definicion:
    ...
    },
    {
      ...
      archivo: 'ya10-2',
      hay_datos: true,
      explicacion_umbral: 'De acuerdo con el Plan Nacional de Desarrollo 2022 - 2026 no hay una meta para este indicador. Sin embargo el umbral debe ser cero.',
      ...
      unidad: 'Conteo',
      fuente_numerador: 'DANE: Integración de datos y estimación estadística de víctimas en el marco del conflicto armado ( CEV - JEP - HRDAG ).',
      ...
      desagregacion: 'Municipal',
      contexto: 'Arias et al., (214) han estudiando los efectos del conflicto armado en el desarrollo económico y social en Colombia, de acuerdo con los autores el conflicto armad ha tenido efectos devastadores en el sistema educativo del país. Las instituciones educativas, tanto oficiales como no oficiales, han enfrentado numerosos desafíos debido a la violencia y la inestabilidad asociadas con el conflicto. Muchas escuelas han sido afectadas directamente, ya sea por actos de violencia que las han dejado inoperables o por la desaparición de recursos esenciales. Además, el desplazamiento forzado de comunidades enteras ha tenido un impacto directo en la tasa de matricula y la asistencia escolar, ya que muchos niños y jóvenes se han visto obligados a abandonar sus hogares y, en consecuencia, sus estudios. Este entorno de conflicto también ha llevado a la pérdida de maestros capacitados, ya sea porque han sido desplazados o han abandonado sus roles por motivos de seguridad.',
      interpretacion: 'Un valor de 5 indica que 5 menores de edad  fueron víctimas de reclutamiento en un momento y territorio determinados.',
    },
    {
      ...
      interpretacion: 'Un valor de 20 indica que en un mismo periodo y territorio en particular se presentaron 20 ataques armados a la población civil. El indicador no pondera un peso en particular en función de la categoría que integran el agregado de "Ataques Armados".',
    },
    {
