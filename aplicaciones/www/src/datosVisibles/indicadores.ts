...
const datos: DatosYa[] = [
  {
    ...
    imagen: 'ya1',
    indicadores: [
      { nombre: 'Cobertura de acueducto', ruta: 'acueducto', archivo: 'ya1-1', mun: true, dep: true },
      { nombre: 'Cobertura alcantarillado', ruta: 'alcantarillado', archivo: 'ya1-2', mun: true, dep: true },
      {
      ...
      { nombre: 'Control prenatal', ruta: 'control-prenatal', archivo: 'ya1-5', mun: true, dep: true },
      { nombre: 'Desnutrición aguda y crónica', ruta: 'desnutricion', archivo: 'ya1-7', mun: true, dep: true },
      { nombre: 'Bajo peso al nacer', ruta: 'bajo-peso', archivo: 'ya1-8', mun: true, dep: true },
    ],
  },
  {
