  ...
  indicadores: [
    {
      ...
      interpretacion:
        'Este indicador busca evaluar la existencia y el cumplimiento de comités a nivel local y regional que estén comprometidos con asegurar que los niños, niñas y adolescentes tengan una voz activa y relevante en la elaboración y ejecución de políticas que afectan directamente sus vidas. La presencia de estos comités y su adhesión al decreto indicaría un enfoque institucional en la inclusión y participación de la juventud en el proceso de toma de decisiones. <br/><br/>Más información: Ben-Arieh, A. & Gross-manos, D. (2009). <i>Taxonomy for child well being indicators.</i> https://www.icbf.gov.co/system/files/guia_6_indicadores_de_participacion_de_ninos_nina_y_adolescentes.pdf. <i>The 3rd OECD World Forum on Statistics, Knowledge and Policy. Charting Progress, Building Visions, Improving Life.</i> Consultado en la página web: http://www.oecd.org/site/progresskorea/44120532.pdf.',
    ...
    },
    {
      ...
      desagregacion: 'Municipal',
      interpretacion:
        'Este indicador se interpreta como la cantidad de niños, niñas y adolescentes que están involucrados de manera significativa en los análisis de la situación de salud, específicamente con un enfoque centrado en los derechos. La participación activa de estos jóvenes en la evaluación de la situación de salud implica que están contribuyendo de manera sustancial al proceso de comprensión y evaluación de las condiciones de salud en su comunidad o área geográfica. Interpretar positivamente este indicador sugiere que los niños, niñas y adolescentes no solo son considerados en la planificación y ejecución de acciones de salud, sino que también están participando activamente en la identificación de problemas, necesidades y prioridades en el ámbito de la salud con un enfoque de derechos. <br/><br/>Más información: Ben-Arieh, A. & Frones, I. (2011). <i>Taxonomy for child well being indicators: A framework for the analysis of the well-being of children.</i> Childhood. 18: 460-476. https://www.icbf.gov.co/system/files/guia_6_indicadores_de_participacion_de_ninos_nina_y_adolescentes.pdf.',
      responsable:
        'Ministerio de Salud y Protección Social - Sistema de información de seguimiento y evaluación de la gestión',
      compete_a:
        'Ministerio de Educación, Instituto Colombiano de Bienestar Familiar (ICBF) y Secretarías de Educación.',
