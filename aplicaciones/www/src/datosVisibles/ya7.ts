  ...
  indicadores: [
    {
      ...
      contexto:
        'En el contexto colombiano, el Coeficiente de Gini se ha convertido en una herramienta crucial para evaluar la distribución de ingresos en el país. Este indicador, que varía entre cero y uno, ofrece una perspectiva reveladora sobre la desigualdad económica en Colombia. Cuando el Gini se acerca a cero, sugiere una distribución más equitativa de los ingresos entre los hogares, mientras que un valor cercano a uno indica una concentración significativa de ingresos en un segmento reducido de la población. La curva de Lorenz, que representa visualmente esta distribución, se ha convertido en un elemento esencial para comprender la disparidad de ingresos en el país. En un esfuerzo por abordar la desigualdad económica, Colombia ha implementado diversas políticas y programas destinados a mejorar la equidad en la distribución de ingresos y proporcionar oportunidades más equitativas para todos los ciudadanos. A través de la evaluación continua del Coeficiente de Gini, Colombia busca avanzar hacia una sociedad más inclusiva y justa en términos económicos. <br/><br/>Más información: https://datos.bancomundial.org/indicator/SI.POV.GINI?locations=CO.',
      interpretacion:
        'El Coeficiente de Gini, empleado con frecuencia para evaluar la desigualdad en la distribución de ingresos en un país, se expresa como la discrepancia entre la curva de Lorenz y la línea de equidistribución en términos gráficos. Este coeficiente varía de 0 a 1, reflejando diferentes niveles de desigualdad. La curva de Lorenz, que representa visualmente la distribución de ingresos en una población, muestra en el eje vertical el porcentaje acumulado de ingresos y en el horizontal el porcentaje acumulado de hogares o personas correspondientes a dichos ingresos. En una distribución perfectamente equitativa, la curva seguiría una línea de 45 grados; en caso de desigualdad total, la curva se ubicaría sobre el eje X. <br/><br/>Interpretación del Coeficiente <br/>Gini cercano a 0: sugiere una distribución de ingresos más equitativa, esto implica que los ingresos están repartidos de manera más uniforme entre los hogares. <br/>Gini cercano a 1: indica una mayor desigualdad, esto significa que hay una concentración significativa de ingresos en un segmento más pequeño de la población. <br/><br/>En el caso de Colombia, el Gini proporciona información valiosa sobre la disparidad económica en la sociedad.',
    },
    {
