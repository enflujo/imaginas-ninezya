...
export const ya9: DatosYa = {
  ...
  indicadores: [
    ...
    },
    {
      ...
      hay_datos: false,
      definicion:
        ' Se refiere a la cantidad total de casos que han sido tratados o concluidos dentro de los programas de justicia restaurativa a nivel nacional. La justicia restaurativa es un enfoque no cinvencional que busca resolver conflictos y delitos mediante la reconciliación y la reparación, priorizando la restauración de relaciones en las comunidades, a través de intervenciones directas. Más información: https://www.icbf.gov.co/bienestar/proteccion/responsabilidad-penal.',
