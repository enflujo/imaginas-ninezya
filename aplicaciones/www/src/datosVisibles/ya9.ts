  ...
  indicadores: [
    {
      ...
      archivo: 'ya9-1',
      hay_datos: false,
      definicion: 'Este indicador valúa la recurrencia de ingreso de adolescentes al Sistema de Responsabilidad Penal Adolescente (SRPA) debido a la presunta comisión de un delito. Se calcula dividiendo el número de adolescentes que ingresan al SRPA en más de una ocasión entre el total de adolescentes que ingresan al sistema, expresado como un porcentaje. Más información: https://www.icbf.gov.co/bienestar/proteccion/responsabilidad-penal.',
      metodologia:
      ...
      interpretacion:
        'Se interpreta como la proporción de adolescentes que tienen múltiples ingresos al Sistema de Responsabilidad Penal Adolescente (SRPA) en comparación con el total de adolescentes que ingresan al sistema en un período específico. Alto Porcentaje: Un porcentaje elevado indica que una proporción significativa de adolescentes que ingresan al SRPA lo hacen en más de una ocasión. Esto podría sugerir la existencia de problemas sistémicos o la necesidad de intervenciones más efectivas para prevenir la reincidencia. Bajo Porcentaje: Un porcentaje más bajo sugiere que la mayoría de los adolescentes ingresan al SRPA en una sola ocasión, lo cual podría ser indicativo de programas de prevención o rehabilitación exitosos que ayudan a evitar la reincidencia.',
      responsable:
        'Instituto Colombiano de Bienestar Familiar (ICBF)',
      compete_a:
        'Ministerio de Educación, Instituto Colombiano de Bienestar Familiar (ICBF), Fiscalía General de la Nación, y Secreatrías de Educación o Seguridad; de acuerdo a la estructura institucional de cada municipio o departamento.',
    },
    {
      ...
      archivo: 'ya9-2',
      hay_datos: false,
      definicion: 'Es un indicador que mide la duración media en la cual un adolescente o joven permanece en una medida de internamiento preventivo. Este tipo de medida se aplica como precaución antes de que se haya llevado a cabo un juicio o haya una decisión final sobre el caso legal del individuo. Más información: https://www.icbf.gov.co/bienestar/proteccion/responsabilidad-penal.',
      metodologia:
    ...
    },
    {
      ...
      archivo: 'ya9-3',
      hay_datos: false,
      definicion: ' Se refiere a la cantidad total de casos que han sido tratados o concluidos dentro de los programas de justicia restaurativa a nivel nacional. La justicia restaurativa es un enfoque no cinvencional que busca resolver conflictos y delitos mediante la reconciliación y la reparación, priorizando la restauración de relaciones en las comunidades, a través de intervenciones directas. Más información: https://www.icbf.gov.co/bienestar/proteccion/responsabilidad-penal.',
      metodologia:
        'Número total de casos abordados o finalizados en un mismo periodo y territorios específicos',
      unidad: 'Conteo',
      desagregacion: 'Municipal',
      interpretacion:
        'Este indicador cuantifica el número de casos de SRPA que han sido tratados o concluidos a través de los programas de justicia restaurativa a nivel nacional. Aquí hay algunas consideraciones para la interpretación: Alto Número: Un alto número de casos abordados o finalizados podría interpretarse como una mayor utilización y eficacia de los programas de justicia restaurativa en el país. Indicaría que un gran número de casos ha pasado por estos programas y ha llegado a una resolución mediante enfoques restaurativos. Bajo Número: Un bajo número podría sugerir una menor participación o implementación limitada de programas de justicia restaurativa. Podría indicar la necesidad de aumentar la conciencia sobre estos programas o mejorar su accesibilidad y aceptación. Tendencia a lo largo del tiempo: Observar cómo cambia el número de casos abordados o finalizados a lo largo del tiempo proporcionará información sobre la evolución y efectividad de los programas de justicia restaurativa en el país. La interpretación depende de la comparación con otros periodos de tiempo, las metas establecidas, y el contexto del sistema de justicia restaurativa en el país.',
      responsable:
        'Instituto Colombiano de Bienestar Familiar (ICBF)',
      compete_a:
        'Ministerio de Educación, Instituto Colombiano de Bienestar Familiar (ICBF), Fiscalía General de la Nación, y Secreatrías de Educación o Seguridad; de acuerdo a la estructura institucional de cada municipio o departamento.',
    ...
    {
      nombre: 'Porcentaje de adolescentes o jóvenes en Centros de Atención Especializada y Centros de Internamiento Preventivo con acceso al sistema educativo.',
      ruta: 'cae-acceso-educativo',
      archivo: 'ya9-4',
      hay_datos: false,
      definicion: 'Se refiere a la proporción de adolescentes y/o jóvenes que se encuentran en instalaciones como Centros de Atención Especializada y Centros de Internamiento Preventivo y que tienen acceso al sistema educativo. En otras palabras, mide la cantidad de jóvenes en centros especializados o de internamiento preventivo que participan en programas educativos en relación con el total de jóvenes en esas instalaciones. Más información: https://www.icbf.gov.co/bienestar/proteccion/responsabilidad-penal.',
      metodologia:
      ...
      desagregacion: 'Municipal',
      interpretacion:
        'Se debe evaluar el porcentaje obtenido a partir de la fórmula proporcionada. Alto Porcentaje: Un porcentaje elevado indica que una proporción significativa de los adolescentes o jóvenes en Centros de Atención Especializada y Centros de Internamiento Preventivo tiene acceso al sistema educativo. Esto sugiere que se están implementando medidas exitosas para proporcionar oportunidades educativas dentro de estas instalaciones. Bajo Porcentaje: Un porcentaje más bajo indica que una proporción menor de los jóvenes en estas instalaciones tiene acceso al sistema educativo. Esto podría señalar la necesidad de mejorar y expandir programas educativos dentro de los centros para brindar más oportunidades de aprendizaje a los jóvenes. La interpretación precisa también debe considerar el contexto, los objetivos y las metas específicas del sistema de justicia juvenil y educativo en el país o región. Además, el seguimiento del indicador a lo largo del tiempo puede proporcionar información sobre tendencias y cambios en el acceso a la educación para este grupo de población.',
        responsable:
        'Instituto Colombiano de Bienestar Familiar (ICBF)',
      compete_a:
        'Ministerio de Educación, Instituto Colombiano de Bienestar Familiar (ICBF), Fiscalía General de la Nación, y Secreatrías de Educación o Seguridad; de acuerdo a la estructura institucional de cada municipio o departamento.',
