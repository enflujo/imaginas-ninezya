  ...
  indicadores: [
    {
      ...
      contexto:
        'En el contexto colombiano, el Coeficiente de Gini se ha convertido en una herramienta crucial para evaluar la distribución de ingresos. Este indicador, que varía entre cero y uno, ofrece una perspectiva reveladora sobre la desigualdad económica en Colombia. Cuando el Gini se acerca a cero, sugiere una distribución más equitativa de los ingresos entre los hogares, mientras que un valor cercano a uno indica una concentración significativa de ingresos en un segmento reducido de la población. <br/><br/>En un esfuerzo por abordar la desigualdad económica, Colombia ha implementado diversas políticas y programas destinados a mejorar la equidad en la distribución de ingresos y proporcionar oportunidades más equitativas para todos los ciudadanos. A través de la evaluación continua del Coeficiente de Gini, el país busca avanzar hacia una sociedad más inclusiva y justa en términos económicos. <br/><br/>Más información: https://datos.bancomundial.org/indicator/SI.POV.GINI?locations=CO',
      interpretacion:
