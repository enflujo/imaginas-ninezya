...
export const ya9: DatosYa = {
  ...
  indicadores: [
    ...
    },
    {
      ...
      hay_datos: true,
      umbral: 0,
      explicacion_umbral: 'No se define un umbral fijo; la meta se orienta hacia la mejora continua en la reducción del uso de medidas privativas de la libertad, en línea con los principios de los Objetivos de Desarrollo Sostenible (ODS) 16, que busca "Paz, justicia e instituciones sólidas."',
      explicacion:
    ...
    },
    {
      ...
      hay_datos: true,
      umbral: 0,
      explicacion_umbral: 'Este indicador mide el porcentaje de niñas, niños y adolescentes de 5 a 17 años que ingresaron a un Proceso de Restablecimiento de Derechos debido a situaciones de explotación sexual comercial.',
      explicacion:
      ...
      fuente_denominador: 'Instituto Colombiano de Bienestar Familiar (ICBF)',
      desagregacion: 'Departamental',
      contexto: 'Este indicador refleja la atención institucional y la respuesta a casos de violencia y explotación sexual comercial contra niñas, niños y adolescentes en procesos de protección de derechos en el país.',
      interpretacion:
