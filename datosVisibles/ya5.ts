...
export const ya5: DatosYa = {
  ...
  indicadores: [
    ...
    },
    {
      ...
      metodologia:
        'No. de niños y niñas de 2-5 años que con frecuencia cuentan en su hogar con adulto que lee junto a el libros de cuentos o historias / Número total de niños y niñas de 2-5 años * 100.000 niños',
      unidad: 'Tasa',
      desagregacion: 'Municipal',
      interpretacion:
